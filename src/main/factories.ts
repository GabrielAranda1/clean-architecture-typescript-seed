...
export async function initializeContainer() {
  ...
  container.register<ICreateCustomerUseCase>(
    'ICreateCustomerUseCase',
    CreateCustomerUseCase,
  )
  container.register<GetCustomerByIdUseCase>(
  ...
  container.register<IUpdateProductUseCase>(
    'IUpdateProductUseCase',
    UpdateProductUseCase,
  )
  container.register<IGetProductByIdUseCase>(
    'IGetProductByIdUseCase',
    GetProductByIdUseCase,
  )
  container.register<IGetProductsByIdsUseCase>(
